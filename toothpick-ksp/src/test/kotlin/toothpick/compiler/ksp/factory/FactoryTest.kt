...
class FactoryTest {
    ...
    @Test
    @DisplayName("with singleton annotation")
    fun testSingletonAnnotation_isSet() {
        // Given
        val kotlinSource = SourceFile.kotlin(
            trimIndent = true,
            name = "SingletonClass.kt",
            contents = """
                package test
        ...
        assertEquals(
            ...
            public class SingletonClass__Factory : Factory<SingletonClass> {
              public override fun createInstance(scope: Scope): SingletonClass {
            ...
            File(
                compilationResult.outputDirectory,
                "../ksp/sources/kotlin/test/SingletonClass__Factory.kt"
            ).readText()
        )
    }
